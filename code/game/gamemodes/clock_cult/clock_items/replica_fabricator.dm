...
<<<<<<< HEAD:code/game/gamemodes/clock_cult/clock_items/clockwork_proselytizer.dm
...
>>>>>>> 5884071627... Renames Clockwork Proselytizers to Replica Fabricators (#28062):code/game/gamemodes/clock_cult/clock_items/replica_fabricator.dm
