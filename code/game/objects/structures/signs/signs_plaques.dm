...
/obj/structure/sign/plaques/kiddie
	...
	desc = "Next to the extremely long list of names and job titles, there is a drawing of a little child. The child appears to be dumb. Beneath the image, someone has scratched the word \"PACKETS\"."
