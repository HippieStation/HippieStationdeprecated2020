...
/obj/item/stack/medical/bruise_pack
	...
	var/heal_brute = 40
	self_delay = 20
	grind_results = list(/datum/reagent/medicine/styptic_powder = 10) // hippie -- no cobbychem
...
/obj/item/stack/medical/ointment
	...
	var/heal_burn = 40
	self_delay = 20
	grind_results = list(/datum/reagent/medicine/silver_sulfadiazine = 10) // hippie -- no cobbychem
