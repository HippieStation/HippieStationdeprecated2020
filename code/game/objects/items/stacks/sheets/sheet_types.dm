...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	null, \
	new/datum/stack_recipe("iron door", /obj/structure/mineral_door/iron, 20, time = 20, one_per_turf = TRUE, on_floor = TRUE), \ // hippie -- add cooldown
	new/datum/stack_recipe("floodlight frame", /obj/structure/floodlight_frame, 5, time = 10, one_per_turf = TRUE, on_floor = TRUE), \ // hippie -- add cooldown
))
