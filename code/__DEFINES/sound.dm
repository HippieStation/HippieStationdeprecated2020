...
#define RUINS list('sound/ambience/ambimine.ogg', 'sound/ambience/ambimaint1.ogg')
...
#define MINING list('sound/ambience/ambimine.ogg',\
						 			'sound/ambience/ambimaint1.ogg', 'sound/ambience/ambilava.ogg')
...
#define MAINTENANCE list('sound/ambience/ambimaint1.ogg', 'sound/ambience/ambimaint2.ogg', 'sound/ambience/ambimaint3.ogg', 'sound/ambience/ambimaint4.ogg',\
											'sound/ambience/ambimaint5.ogg', 'sound/voice/lowHiss2.ogg', 'sound/voice/lowHiss3.ogg', 'sound/voice/lowHiss4.ogg' )
