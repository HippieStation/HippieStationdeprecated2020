...
/datum/uplink_item/cyber_implants/spawn_item(turf/loc, datum/component/uplink/U, mob/user) // hippie-code: changed this to use the component because /tg/ is bad
	if(item)
