...
/datum/chemical_reaction/inacusiate
	...
	required_reagents = list(/datum/reagent/water = 1, /datum/reagent/carbon = 1, /datum/reagent/medicine/charcoal = 1) // hippie -- no cobbychems
...
/datum/chemical_reaction/oculine
	...
	required_reagents = list(/datum/reagent/medicine/charcoal  = 1, /datum/reagent/carbon = 1, /datum/reagent/hydrogen = 1) // hippie -- no cobbychems
...
/datum/chemical_reaction/antihol
	...
	required_reagents = list(/datum/reagent/consumable/ethanol = 1, /datum/reagent/medicine/charcoal  = 1, /datum/reagent/copper = 1) // hippie -- no cobbychems
