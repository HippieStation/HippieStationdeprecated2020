...
/datum/reagent/consumable/ethanol/applejack
	...
	glass_desc = "The name applejack derives from the traditional method of producing the drink, jacking, the process of freezing fermented cider and then removing the ice, increasing the alcohol content."
