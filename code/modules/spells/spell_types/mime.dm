...
/obj/effect/proc_holder/spell/targeted/mime/dummy_talk_into
	...
	desc = "Maniupliate the ventriloquist dummy to talk without breaking the mime's vow of silence."
	school = "mime"
	panel = "Mime"
	clothes_req = FALSE
	sound = null
...
/obj/effect/proc_holder/spell/targeted/mime/dummy_talk_into/Click(atom/movable/A)
	var/obj/item/I = usr.is_holding_item_of_type(/obj/item/toy/dummy)
	if(I)
...
/obj/effect/proc_holder/spell/targeted/mime/dummy_talk_into/GetVoice()
