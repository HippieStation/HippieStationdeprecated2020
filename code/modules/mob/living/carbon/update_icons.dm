...
/mob/living/carbon/update_inv_wear_mask()
	...
	if(client && hud_used && hud_used.inv_slots[ITEM_SLOT_MASK])
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_MASK]
		inv.update_icon()
...
/mob/living/carbon/update_inv_neck()
	...
	if(client && hud_used && hud_used.inv_slots[ITEM_SLOT_NECK])
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_NECK]
		inv.update_icon()
...
/mob/living/carbon/update_inv_back()
	...
	if(client && hud_used && hud_used.inv_slots[ITEM_SLOT_BACK])
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_BACK]
		inv.update_icon()
...
/mob/living/carbon/update_inv_head()
	...
	if(client && hud_used && hud_used.inv_slots[ITEM_SLOT_BACK])
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_HEAD]
		inv.update_icon()
