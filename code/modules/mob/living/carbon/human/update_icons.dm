...
/mob/living/carbon/human/update_inv_w_uniform()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_ICLOTHING]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_wear_id()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_ID]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_gloves()
	...
	if(client && hud_used && hud_used.inv_slots[ITEM_SLOT_GLOVES])
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_GLOVES]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_glasses()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_EYES]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_ears()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_EARS]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_shoes()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_FEET]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_s_store()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_SUITSTORE]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_belt()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_BELT]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_wear_suit()
	...
	if(client && hud_used)
		var/obj/screen/inventory/inv = hud_used.inv_slots[ITEM_SLOT_OCLOTHING]
		inv.update_icon()
...
/mob/living/carbon/human/update_inv_pockets()
	if(client && hud_used)
		...
		inv = hud_used.inv_slots[ITEM_SLOT_LPOCKET]
		inv.update_icon()

		inv = hud_used.inv_slots[ITEM_SLOT_RPOCKET]
		inv.update_icon()
