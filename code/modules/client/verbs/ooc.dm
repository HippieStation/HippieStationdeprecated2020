...
/client/verb/ooc(msg as text)
	...
	for(var/client/C in GLOB.clients)
		if(C.prefs.chat_toggles & CHAT_OOC)
			var/ooc_icons = ""	// hippie start -- custom ooc icons depending on rank, the actual ooc icon insertion as well as mentor and donator ooc colours
			add_ooc_icons()
			if(holder)
				if(!holder.fakekey || C.holder)
					...
					if(GLOB.OOC_COLOR)
						...
						to_chat(C, "<span class='ooc'><span class='prefix'>[ooc_icons] OOC:</span> <EM>[holder.fakekey ? holder.fakekey : key]:</EM> <span class='message linkify'>[msg]</span></span>")
			else if(is_mentor())
				to_chat(C, "<font color='[HIPPIE_MENTOR_OOC_COLOUR]'><span class='ooc'><span class='prefix'>[ooc_icons] OOC:</span> <EM>[keyname]:</EM> <span class='message linkify'>[msg]</span></span>")
			else if(is_donator)
				to_chat(C, "<font color='[HIPPIE_DONATOR_OOC_COLOUR]'><span class='ooc'><span class='prefix'>[ooc_icons] OOC:</span> <EM>[keyname]:</EM> <span class='message linkify'>[msg]</span></span>")
