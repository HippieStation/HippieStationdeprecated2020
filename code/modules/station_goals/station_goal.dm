...
/datum/station_goal/proc/send_report()
	priority_announce("Priority Nanotrasen directive received. Project \"[name]\" details inbound.", "Incoming Priority Message", 'hippiestation/sound/pyko/commandreport.ogg') // hippie -- pykoai
