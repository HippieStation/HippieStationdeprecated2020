...
/datum/techweb_node/cyborg_upg_med
	...
	prereq_ids = list("adv_biotech")
	design_ids = list("borg_upgrade_piercinghypospray", "borg_upgrade_expandedsynthesiser", "borg_upgrade_pinpointer") //hippie edit -- removed defib and surgery processor
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2000)
	export_price = 5000
...
/datum/techweb_node/nanite_bio
	...
	design_ids = list("regenerative_nanites", "bloodheal_nanites", "coagulating_nanites","poison_nanites","flesheating_nanites",\
					"sensor_crit_nanites","sensor_death_nanites", "sensor_health_nanites", "sensor_damage_nanites", "sensor_species_nanites", "sensor_emote_nanites") //hippie edit -- add emote nanites
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 500, TECHWEB_POINT_TYPE_NANITES = 500)
	export_price = 5000
