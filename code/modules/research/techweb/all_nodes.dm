...
/datum/techweb_node/intermediate_bluespace_travel
	id = "bluespace_travel"
	display_name = "Bluespace Travel"
	description = "Application of Bluespace for static teleportation technology."
	prereq_ids = list("practical_bluespace")
	design_ids = list("tele_station", "tele_hub", "teleconsole", "quantumpad", "launchpad", "launchpad_console", "bluespace_pod")// , "rcs", "cargo_beacon" NYI
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 5000)
	export_price = 5000

/datum/techweb_node/advanced_bluespace_travel
	id = "advanced_bluespace_travel"
	display_name = "Advanced Bluespace Travel"
	description = "Finely controlled static bluespace teleportation technology."
