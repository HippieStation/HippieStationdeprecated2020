...
/client/proc/cmd_debug_mob_lists()
	...
	switch(input("Which list?") in list("Players","Admins","Mobs","Living Mobs","Dead Mobs","Clients","Joined Clients"))
		if("Players")
			to_chat(usr, jointext(GLOB.player_list,","), confidental = TRUE)
		if("Admins")
			to_chat(usr, jointext(GLOB.admins,","), confidental = TRUE)
		if("Mobs")
			to_chat(usr, jointext(GLOB.mob_list,","), confidental = TRUE)
		if("Living Mobs")
			to_chat(usr, jointext(GLOB.alive_mob_list,","), confidental = TRUE)
		if("Dead Mobs")
			to_chat(usr, jointext(GLOB.dead_mob_list,","), confidental = TRUE)
		if("Clients")
			to_chat(usr, jointext(GLOB.clients,","), confidental = TRUE)
		if("Joined Clients")
			to_chat(usr, jointext(GLOB.joined_player_list,","), confidental = TRUE)
