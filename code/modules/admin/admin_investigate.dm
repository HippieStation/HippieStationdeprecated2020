...
/client/proc/investigate_show()
	...
	if(!fexists(F))
		...
		return
	src << browse(F,"window=investigate[selected];size=800x300")
>>>>>>> ac9dd6b... Remove small text formatting from investigate log (#43273)
