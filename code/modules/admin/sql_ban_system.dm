...
/datum/admins/proc/ban_panel(player_key, player_ip, player_cid, role, duration = 1440, applies_to_admins, reason, edit_id, page, admin_key)
	...
	if(edit_id)
		...
		var/list/long_job_lists = list("Civilian" = GLOB.civilian_positions,
									...
									ROLE_TRAITOR, ROLE_WIZARD, ROLE_HOLOPARASITE, CATBAN, CLUWNEBAN, CRABBAN)) //ROLE_REV_HEAD is excluded from this because rev jobbans are handled by ROLE_REV // Hippie edit -- Adds holopara, cluwne, crab, and cat bans
