...
/datum/controller/subsystem/shuttle/proc/CheckAutoEvac()
	...
	if(alive / total <= threshold)
		...
		priority_announce("Catastrophic casualties detected: crisis shuttle protocols activated - jamming recall signals across all frequencies.", null, 'hippiestation/sound/pyko/catastrophic.ogg', "Red Alert") // hippie -- pykoai
...
/datum/controller/subsystem/shuttle/proc/checkHostileEnvironment()
	...
	if(!emergencyNoEscape && (emergency.mode == SHUTTLE_STRANDED))
		...
		priority_announce("Hostile environment resolved. \
			...
			null, 'hippiestation/sound/pyko/shuttledock.ogg', "Priority")
