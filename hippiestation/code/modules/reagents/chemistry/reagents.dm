...
//liquid
	var/list/chempile_reagent_blacklist = list("lean", "water", "lube", "bleach", "cleaner", "colorful_reagent", "condensedcapsaicin", "radium", "thermite", "smoke_powder", "sugar")//add stuff that doesn't make sense/is too op for turfchems
