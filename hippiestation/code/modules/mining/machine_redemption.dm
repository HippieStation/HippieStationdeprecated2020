...
/obj/machinery/mineral/ore_redemption/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += "The status display reads: Smelting <b>[sheet_per_ore]</b> sheet(s) per piece of ore.<br>Reward point generation at <b>[point_upgrade*100]%</b>.<br>Ore pickup speed at <b>[ore_pickup_rate]</b>."
