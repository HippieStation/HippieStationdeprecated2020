/obj/item/clothing/under/rank/clown/Initialize()
	...
	for(var/datum/component/c in squeaks)
		c.RemoveComponent()
	AddComponent(/datum/component/squeak, list('hippiestation/sound/misc/hitsounds/cartoon_badoing.ogg'=1,
                                               ...
                                               'hippiestation/sound/misc/hitsounds/cartoon_woink.ogg'=1), 50)