...
/obj/machinery/power/power_laser
	name = "power laser"
	icon = 'hippiestation/goon/icons/pt_laser.dmi' // huge thanks to goon for the sprite!
...
/obj/machinery/power/power_laser/proc/emit_beam()
	...
	if(!target)
		target = turfEnd
	beam = Beam(turfStart, target, icon = 'hippiestation/goon/icons/ptlbeam.dmi', icon_state = "ptl_beam",maxdistance=INFINITY,btype = /obj/effect/ebeam/ptl, beam_sleep_time=1)
...
/datum/beam/pl_beam
	icon = 'hippiestation/goon/icons/ptlbeam.dmi'
	icon_state = "ptl_beam"
	var/dir = SOUTH
