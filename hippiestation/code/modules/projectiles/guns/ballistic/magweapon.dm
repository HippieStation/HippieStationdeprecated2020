...
//credit to shitadel - they know what they are doing.
...
/obj/item/gun/ballistic/automatic/magrifle
	...
	fire_sound = 'hippiestation/sound/weapons/magrifle.ogg'
	can_suppress = 0
	burst_size = 3
	fire_delay = 2
	spread = 5
...
/obj/item/gun/ballistic/automatic/hyperburst
	...
	fire_sound = 'hippiestation/sound/weapons/magburst.ogg'
	can_suppress = 0
	burst_size = 1
	fire_delay = 40
	recoil = 2
...
/obj/item/projectile/beam/lasertag/mag		//the projectile, compatible with regular laser tag armor
	icon = 'hippiestation/icons/obj/guns/cit_guns.dmi'
	icon_state = "magjectile-toy"
	name = "lasertag magbolt"		//for penetration memes
