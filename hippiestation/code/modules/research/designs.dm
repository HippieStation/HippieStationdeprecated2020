...
/datum/design/synth_xeno_sack
			...
			materials = list(MAT_PLASMA = 1500, MAT_GLASS = 2000)
			build_path = /obj/item/organ/alien/eggsac
			category = list("Organs")

/datum/design/synth_hive_node
			name = "Synthetic Hive Node"
			desc = "A synthetic xenomorph hive node allows you to talk to aliens and allows you to use an egg sack."
			id = "synth_hive_node"
			build_type = PROTOLATHE
			req_tech = list("abductor" = 3, "biotech" = 2)
