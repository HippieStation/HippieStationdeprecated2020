...
/obj/item/weapon/melee/baseball_bat/New()
	moptions["Default"] = "baseball_bat_og"
	moptions["Metal"] = "baseball_bat_metal"
	moptions["Spiked"] = "baseball_bat_spiked"
	moptions["Ugly Stick"] = "baseball_bat"
	moptions["Cancel"] = null

/obj/item/weapon/melee/baseball_bat/attackby(obj/item/A, mob/user, params)
	if(melee_rename)
