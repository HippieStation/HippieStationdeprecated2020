...
/obj/structure/flora/maintenanceshroom/bluemushroom
	icon = 'hippiestation/icons/obj/maint_flora.dmi'
	icon_state = "bluemushroom"
	name = "small blue mushrooms"
	desc = "A number of small blue mushrooms, growing in the station's maintenance tunnels. They appear to be glowing slightly..."
	harvested_name = "harvested blue mushrooms"
	harvested_desc = "Some recently harvested blue mushrooms. They'll probably grow back soon."
	harvest = /obj/item/reagent_containers/food/snacks/grown/maintenanceshroom/bluemushroom
	harvest_amount_low = 1
...
/obj/structure/flora/maintenanceshroom/bluemushroom/Initialize(mapload)
...
/obj/item/reagent_containers/food/snacks/grown/maintenanceshroom/bluemushroom
	name = "blue mushrooms"
	desc = "Some blue mushrooms. They're glowing slightly."
	icon = 'hippiestation/icons/obj/maint_flora.dmi'
	icon_state = "bluemushroom_hand"
