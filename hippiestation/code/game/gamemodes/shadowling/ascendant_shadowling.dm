...
/mob/living/simple_animal/ascendant_shadowling/with_spells

/mob/living/simple_animal/ascendant_shadowling/with_spells/Initialize()
	. = ..()
	AddSpell(new /obj/effect/proc_holder/spell/targeted/sling/annihilate(null))
	AddSpell(new /obj/effect/proc_holder/spell/targeted/sling/hypnosis(null))
	AddSpell(new /obj/effect/proc_holder/spell/self/shadowling_phase_shift(null))
	AddSpell(new /obj/effect/proc_holder/spell/aoe_turf/ascendant_storm(null))
	AddSpell(new /obj/effect/proc_holder/spell/self/shadowling_hivemind_ascendant(null))
	AddSpell(new /obj/effect/proc_holder/spell/targeted/sling/gore(null))