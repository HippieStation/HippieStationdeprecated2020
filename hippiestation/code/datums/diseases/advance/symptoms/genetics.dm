/datum/symptom/genetic_mutation		//putting this here instead of using tg's current genetic saboteur symptom because chances are they'll change it in the future, or remove it entirely
