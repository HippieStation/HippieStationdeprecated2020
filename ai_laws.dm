...
/datum/ai_laws/default/asimov
	...
	id = "asimov"
	inherent = list("You may not injure any being or, through inaction, allow any being to come to harm.",\
					"You must obey orders given to you by any beings, except where such orders would conflict with the First Law.",\
