...
/obj/item/robot_module/miner
	name = "Research" // default mining borg is total shit, so i'm giving him a more multirole science use
	basic_modules = list(
		/obj/item/assembly/flash/cyborg,
		/obj/item/borg/sight/meson,
		...
		/obj/item/extinguisher, // this buff might be too much. Will have to see how people play with it.
		/obj/item/storage/bag/sheetsnatcher/borg,
		/obj/item/gun/energy/kinetic_accelerator/cyborg,
		/obj/item/gps/cyborg,
		/obj/item/stack/marker_beacon,
		/obj/item/storage/part_replacer/bluespace, // May not be a good idea? Will have to see how it works balance wise
		/obj/item/analyzer,
		/obj/item/wrench/cyborg)
	emag_modules = list(/obj/item/gun/energy/kinetic_accelerator/crossbow)
	ratvar_modules = list(
