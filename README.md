...
In addition, under Additional Terms 7.f, all work derived from this project, which is not present in upstream projects, intended for other projects, must attribute the original author(s), as shown by the git history of this project, of the work that is being derived.
